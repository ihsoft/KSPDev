...
/// </list>
/// <para>
/// Note that types that implement this interface will <i>never</i> be treated as compound. I.e.
/// <see cref="ConfigAccessor"/> will not try to persist members of the type even though there may
/// be fields attributed with <see cref="PersistentFieldAttribute"/>.
/// </para>
/// </remarks>
/// <example>
...
/// data is invalid. Just ensure that the sate of the object is not changed to keep it consistent.
/// </para>
/// </example>
/// <seealso cref="ConfigAccessor"/>
/// <seealso cref="PersistentFieldAttribute"/>
public interface IPersistentField {
  /// <summary>Returns objects state as a plain string.</summary>
  /// <returns>Object's state.</returns>
  string SerializeToString();

  /// <summary>Restores objects state from a plain string.</summary>
