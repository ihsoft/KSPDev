...
* [Enhancement] Add debug GUI for parts adjusting: [`DebugGui.MakePartDebugDialog`](http://ihsoft.github.io/KSPDev/Utils/html/T_KSPDev_DebugUtils_DebugGui_MakePartDebugDialog.htm).
